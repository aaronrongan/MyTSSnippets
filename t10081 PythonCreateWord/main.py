...
APP_TITLE = u'文档自动生成'
APP_ICON = 'C:/Program Files/Microsoft VS Code/resources/app/resources/win32/python.ico' # 请更换成你的icon
...
Path_LGF='C:/Users/Aaron/Documents/MyZoteroFiles_LGF'
Path_THF='C:/Users/Aaron/Documents/MyZoteroFiles_THF'
...
class mainFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        # pnl = wx.Panel(self) 
        wx.StaticText(self, -1, u'文件类型：', pos=(10,10), size=(80, -1), style=wx.ALIGN_LEFT)
        # root_filetype=Tk()
        ...
        self.rb7 = wx.RadioButton(self, label = 'LGF',pos = (10,120)) 
        self.rb8 = wx.RadioButton(self, label = 'THF',pos = (10,135)) 

        self.rb1.Bind(wx.EVT_RADIOBUTTON,self.EvtText)
        self.rb2.Bind(wx.EVT_RADIOBUTTON,self.EvtText)
        self.rb3.Bind(wx.EVT_RADIOBUTTON,self.EvtText)
        self.rb4.Bind(wx.EVT_RADIOBUTTON,self.EvtText)
        self.rb5.Bind(wx.EVT_RADIOBUTTON,self.EvtText)
        self.rb6.Bind(wx.EVT_RADIOBUTTON,self.EvtText)
        self.rb7.Bind(wx.EVT_RADIOBUTTON,self.EvtText)
        self.rb8.Bind(wx.EVT_RADIOBUTTON,self.EvtText)

        # self.rb1.Bind(wx.EVT_RADIOBOX,self.onRadio)
        ...
        wx.StaticText(self, -1, u'文件全名：', pos=(80, 40), size=(100, -1), style=wx.ALIGN_RIGHT)
        self.FullFileName = wx.StaticText(self, -1, u'hello', pos=(180, 40), size=(300, -1), style=wx.ST_NO_AUTORESIZE)

        # pnl = wx.Panel(self)
        # wx.StaticText(self, -1, u'文件格式：', pos=(80,60), size=(100, -1), style=wx.ALIGN_RIGHT)
        # self.rb_word = wx.RadioButton(self, label = 'Word',pos = (180,60), size=(50,-1),style=wx.ALIGN_RIGHT) 
        # self.rb_txt = wx.RadioButton(self, label = 'Txt',pos = (270,60), size=(50,-1),style=wx.ALIGN_RIGHT) 

        FileFormatList = ['Word', 'Txt','MD']
        self.rbox = wx.RadioBox(self, label = '文件格式：', pos = (115,60), choices = FileFormatList,
            majorDimension = 1, style = wx.RA_SPECIFY_ROWS)
        # MessageBox(self.rbox.GetSelection)
        # self.rbox.Bind(wx.EVT_RADIOBOX,self.onRadioBox_FileFormat)
        self.rbox.Bind(wx.EVT_RADIOBOX,self.EvtText)
        # MessageBox(wx.EVT_RADIOBOX)
        self.rbox.SetSelection(0)
        
        # lblList = ['Value X', 'Value Y', 'Value Z']
        # self.rbox = wx.RadioBox(self, label = 'RadioBox', pos = (80,60), choices = lblList,
        #  majorDimension = 1, style = wx.RA_SPECIFY_ROWS)
        # self.rbox.Bind(wx.EVT_RADIOBOX,self.onRadioBox_FileFormat)
        
        # btn_mea = wx.Button(self, -1, u'鼠标左键事件', pos=(80, 150), size=(100, 25))
        # btn_meb = wx.Button(self, -1, u'鼠标所有事件', pos=(350, 150), size=(100, 25))
        btn_createfile = wx.Button(self, -1, u'生成文件', pos=(150, 150), size=(100, 30))
        btn_close = wx.Button(self, -1, u'关闭窗口', pos=(300, 150), size=(100, 30))
    ...
    def onRadioBox_FileFormat(self,e):
        ...
        MessageBox(gFormatText)

        # MessageBox(gFormatText)
        # if gFormatText=='Word':
        #     FullFileNameText=TypeText + NumberText + " " + NameText + ".docx"
        # elif gFormatText=='Txt':
        #     FullFileNameText=TypeText + NumberText + " " + NameText + ".txt"
    ...
    def EvtText(self, evt):
        ...
        if self.rb1.Value==True:
            ...
            TypeText='SHF'
        elif self.rb7.Value==True:
            TypeText='LGF'
        elif self.rb8.Value==True:
            TypeText='THF'
        ...
        # MessageBox("rbox:" + str(self.rbox.GetSelection()))
        if self.rbox.GetSelection()==0:
            gFormatText='Word'
            # MessageBox("select Word")
        elif self.rbox.GetSelection()==1:
            gFormatText='Txt'
        elif self.rbox.GetSelection()==2:
            gFormatText='MD'
            # MessageBox("select Txt")
        ...
        if gFormatText=='Word':
            ...
            FullFileNameText=TypeText + NumberText + " " + NameText + ".md"
    ...
    def OnWriteDoc(self, evt):
        ...
        if gFormatText=="Word":
            ...
            # 应该把.docx后缀删除
            ActualFileName1=ActualFileName[:-5]
            # MessageBox(ActualFileName1)
            doc.add_heading(ActualFileName1,level=0)
        ...
        # open an Word document
            ...
            TemplateFileFullPath='C:/Users/Aaron/Documents/MyZoteroFiles_' + FileType

            ActualFileName=self.FullFileName.GetLabel()
            ActualFileName1=ActualFileName[:-4]


            WholePathFileName=TemplateFileFullPath + "/" + ActualFileName

            file1=open(WholePathFileName,'w')
            file1.write(ActualFileName1)    
            file1.write("\r\n")
            file1.write("\r\n")
            file1.write("目的")
            file1.write("\r\n")
